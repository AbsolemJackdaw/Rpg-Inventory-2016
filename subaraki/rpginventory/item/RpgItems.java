...
public class RpgItems {
	...
	public static enum InventoryItem{
		...
		cape_black("black_cape","jewels/cape","blocks/wool_colored_black"),
		cape_red("red_cape","jewels/cape","blocks/wool_colored_red"),
		cape_green("green_cape","jewels/cape","blocks/wool_colored_green"),
		cape_brown("brown_cape","jewels/cape","blocks/wool_colored_brown"),
		cape_blue("blue_cape","jewels/cape","blocks/wool_colored_blue"),
		cape_purple("purple_cape","jewels/cape","blocks/wool_colored_purple"),
		cape_cyan("cyan_cape","jewels/cape","blocks/wool_colored_cyan"),
		cape_silver("silver_cape","jewels/cape","blocks/wool_colored_silver"),
		cape_grey("grey_cape","jewels/cape","blocks/wool_colored_gray"),
		cape_pink("pink_cape","jewels/cape","blocks/wool_colored_pink"),
		cape_lime("lime_cape","jewels/cape","blocks/wool_colored_lime"),
		cape_yellow("yellow_cape","jewels/cape","blocks/wool_colored_yellow"),
		cape_lightblue("lightblue_cape","jewels/cape","blocks/wool_colored_light_blue"),
		cape_magenta("magenta_cape","jewels/cape","blocks/wool_colored_magenta"),
		cape_orange("orange_cape","jewels/cape","blocks/wool_colored_orange"),
